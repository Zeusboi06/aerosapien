...
export default function SkyXSection() {
  const skyXComponents = [
    { title: "High-Altitude UAV Motor Mount Plate", desc: "High-rigidity motor mount plate designed for extreme environmental operation in tactical autonomous drones.", img: "/images/clients/ig-drones/drone-1.png" },
    { title: "Carbon-Aluminium Hybrid Airframe Bracket", desc: "Hybrid structural bracket offering superior strength-to-weight ratio for long-endurance autonomous flight.", img: "/images/clients/ig-drones/drone-3.png" },
