...
export default function HalSection() {
  ...
  const halComponents = [
    ...
    { title: "Wing Structural Attachment Fitting", desc: "Lightweight yet durable aerospace-grade wing structural hardware machined to ±0.001 mm tolerance.", img: "/images/products/lca-wing-structural.png" },
