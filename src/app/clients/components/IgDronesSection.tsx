...
export default function IgDronesSection() {
  const droneComponents = [
    { title: "Tactical UAV T-Joint & Y-Joint Airframe Component", desc: "High-strength structural airframe connector anodized black for 200 kg class logistics UAVs.", img: "/images/components/ig_joints_pair.png" },
    { title: "UAV Motor Mount & Adapter Fitting", desc: "Lightweight high-rigidity motor mount plate engineered for heavy payload multi-rotor UAV platforms.", img: "/images/components/ig_t_joint_single.png" },
    { title: "Landing Gear Shock Strut Component", desc: "Shock-absorbing landing gear strut attachment fitting manufactured from aircraft aluminium.", img: "/images/components/ig_t_joint_single.png" },
    ...
    { title: "Avionics Structural Mounting Plate", desc: "Lightweight vibration-isolated mounting plate for flight controller avionics.", img: "/images/components/ig_joints_pair.png" },
  ];
