...
const capabilitiesCategories = [
  {
    ...
    description: "Sub-millimetre tolerances up to ±0.005 mm across titanium Grade 5, Inconel 718, NCM steel, aluminium, and stainless alloys.",
    icon: Wrench,
    tag: "5-Axis Machining",
    specs: ["5-Axis Simultaneous", "±0.005 mm Tolerance", "Multi-Material"],
    accent: "#00b5e2",
  },
  {
    ...
    icon: Plane,
    tag: "Aero-Structures",
    specs: ["HAL LCA Tejas", "DO-160G Compliant", "ISO 9001:2015 Standards"],
    accent: "#1B6CA8",
  },
  {
...
const technicalMetrics = [
  { label: "Precision Tolerance", value: "±0.005 mm", sub: "Micro-machining standard" },
  { label: "Aerospace Alloys", value: "12+", sub: "Titanium, Inconel, Aluminium" },
  { label: "Certifications", value: "ISO 9001:2015", sub: "Certified Quality" },
    ...
    <Section id="capabilities" className="bg-[#f8fa08]/0 bg-slate-50 relative overflow-hidden py-20 md:py-28 border-t border-slate-200/80">
      ...
      <div className="flex flex-col items-center mb-16 text-center max-w-3xl mx-auto relative z-10 px-4">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--color-deep-navy)] tracking-tight leading-tight">
          Core Engineering & <span className="text-[var(--color-brand-accent)]">Manufacturing Capabilities</span>
        </h2>
