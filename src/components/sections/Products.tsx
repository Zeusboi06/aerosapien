...
import RocketChamber from "@/components/3d/RocketChamber";
...
const products = [
  ...
  },
  {
    ...
    image: "/images/components/ig_joints_pair.png",
  },
  {
    id: 5,
      ...
      <Section id="products" ref={containerRef} className="bg-[#070D18] text-white py-24 border-t border-slate-800/80 relative overflow-hidden">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 relative z-10">
          ...
          <p className="mt-4 text-slate-400 font-sans text-base md:text-lg leading-relaxed">
            ...
            <span className="text-white font-semibold">±0.005 mm</span> tolerance with 100% CMM metrology inspection.
          </p>
        </div>
...
function ProductCard({
  ...
  return (
    <div
      onClick={onClick}
      className="product-card group relative bg-white rounded-2xl overflow-hidden border border-slate-200 hover:border-[var(--color-brand-accent)]/50 transition-all duration-300 cursor-pointer shadow-md hover:shadow-[#00b5e2]/15 hover:-translate-y-1"
    >
      {/* Image area - light grey background */}
      <div className="relative h-56 bg-slate-50 flex items-center justify-center overflow-hidden border-b border-slate-100 p-6">
        <Image
          src={prod.image}
          alt={prod.title}
          fill
      ...
      <div className="p-6 bg-white">
        ...
        <div className="mt-4 flex items-center justify-between pt-3 border-t border-slate-100">
          <span className="text-xs text-slate-500 font-sans">{prod.process}</span>
