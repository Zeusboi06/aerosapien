    ...
    <Section id="contact" className="bg-[#060E18] relative">
      ...
      <div className="text-center max-w-3xl mx-auto mb-14">
        ...
        <p className="mt-4 text-slate-400 font-sans text-base leading-relaxed">
          Ready to elevate your aerospace manufacturing capabilities? Contact our engineering team
      ...
      <div ref={containerRef} className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4 p-5 rounded-xl bg-white/[0.04] border border-white/[0.07] hover:border-[var(--color-brand-accent)]/30 transition-colors group">
              ...
              <div>
                ...
                <a
                  href="https://maps.app.goo.gl/Zmb1M93yYWsT8L648"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 mt-2 text-xs text-[var(--color-brand-accent)] hover:underline font-semibold"
                >
            ...
            <div className="flex items-start space-x-4 p-5 rounded-xl bg-white/[0.04] border border-white/[0.07] hover:border-[var(--color-brand-accent)]/30 transition-colors">
              ...
              <div>
                ...
                <a href="mailto:aerosapien.co.in@gmail.com" className="text-slate-400 font-sans hover:text-[var(--color-brand-accent)] transition-colors text-sm">
            ...
            <div className="flex items-start space-x-4 p-5 rounded-xl bg-white/[0.04] border border-white/[0.07] hover:border-[var(--color-brand-accent)]/30 transition-colors">
              ...
              <div>
                ...
                <a href="tel:+919035744541" className="text-slate-400 font-sans hover:text-[var(--color-brand-accent)] transition-colors text-sm">
                  +91 90357 44541
                </a>
              </div>
            </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/[0.07] h-64 lg:flex-1">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.172615378259!2d77.4848359!3d13.0246773!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae235ad5efb5e5%3A0x57f9d54fd8d8fa56!2sAEROSAPIEN!5e0!3m2!1sen!2sin!4v1690000000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
        ...
        <div className="bg-white/[0.04] p-8 md:p-10 rounded-2xl border border-white/[0.07]">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/[0.04] text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-accent)]/40 focus:border-[var(--color-brand-accent)]/40 transition-all font-sans text-sm"
            ...
            <div className="space-y-2">
              ...
              <textarea
                id="message"
                rows={5}
                className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/[0.04] text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-accent)]/40 focus:border-[var(--color-brand-accent)]/40 transition-all font-sans text-sm resize-none"
                placeholder="Describe your requirement, material, quantity, tolerances..."
              />
            </div>

            <button
              type="submit"
              className="w-full bg-[var(--color-brand-accent)] hover:bg-[#00a0c8] text-white font-bold py-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 group shadow-[0_4px_0_#007a99,0_6px_20px_rgba(0,181,226,0.3)] hover:shadow-[0_2px_0_#007a99,0_4px_14px_rgba(0,181,226,0.25)] active:shadow-none active:translate-y-1"
            >
          ...
          <div className="mt-8 pt-7 border-t border-white/10">
            ...
            <div className="flex gap-2">
              <input
                type="email"
                className="flex-1 px-4 py-2.5 text-sm rounded-lg border border-white/10 bg-white/[0.04] text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-accent)]/40 font-sans"
                placeholder="Email address"
              />
              <button className="px-4 py-2.5 bg-white/[0.07] hover:bg-white/[0.12] text-white font-semibold text-sm rounded-lg transition-colors border border-white/10">
                Subscribe
              </button>
            </div>
          </div>
