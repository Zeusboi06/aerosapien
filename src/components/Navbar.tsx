      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-7">
            ...
            <Link
              href="#contact"
              className="ml-2 px-5 py-2 text-[11px] font-semibold tracking-wider uppercase bg-[var(--color-brand-accent)] text-white rounded hover:bg-white hover:text-[var(--color-deep-navy)] transition-all duration-300 shadow-lg"
            >
              Get a Quote
            </Link>
          </div>
